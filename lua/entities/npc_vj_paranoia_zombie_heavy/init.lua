...
-----------------------------------------------*/
ENT.Model = {"models/vj_paranoia/zombie/zombie_h.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 300
...
ENT.SoundTbl_Idle = {""}
ENT.SoundTbl_Alert = {"vj_paranoia/npc/potolonik/zo_alert10.wav","vj_paranoia/npc/potolonik/zo_alert20.wav","vj_paranoia/npc/potolonik/zo_alert30.wav"}
ENT.SoundTbl_CombatIdle = {"vj_paranoia/npc/potolonik/zo_alert10.wav","vj_paranoia/npc/potolonik/zo_alert20.wav","vj_paranoia/npc/potolonik/zo_alert30.wav"}
ENT.SoundTbl_BeforeMeleeAttack = {"vj_paranoia/npc/potolonik/zo_attack1.wav","vj_paranoia/npc/potolonik/zo_attack2.wav"}
ENT.SoundTbl_Pain = {"vj_paranoia/npc/potolonik/zo_pain1.wav","vj_paranoia/npc/potolonik/zo_pain2.wav"}
ENT.SoundTbl_Death = {"vj_paranoia/npc/potolonik/zo_pain1.wav","vj_paranoia/npc/potolonik/zo_pain2.wav"}
...
function ENT:MultipleMeleeAttacks()
	...
	if randattack == 1 then
	    ...
	    self.SoundTbl_MeleeAttack = {"vj_paranoia/npc/zombie/claw_strike1.wav","vj_paranoia/npc/zombie/claw_strike2.wav","vj_paranoia/npc/zombie/claw_strike3.wav"}
